...
const Upload = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setSuccess("Image uploaded successfully! Redirecting...");
      if (preview) URL.revokeObjectURL(preview);
      setFile(null);
      setPreview(null);
      setProgress(0);
      ...
      <div className="max-w-xl mx-auto p-6 md:p-10">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-4">
          ...
          <button
            ...
            className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-3 rounded-lg transition disabled:opacity-60 disabled:cursor-not-allowed"
          >
